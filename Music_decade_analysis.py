...
plt.savefig("D:\dataset(spotify_139k_)\images/average_song_attributes_by_decades.png", dpi = 300, bbox_inches = "tight")
plt.show()
...
plt.legend()
plt.savefig("D:\dataset(spotify_139k_)\images/Popularity_Distribution_(2000s_vs_2010s).png", dpi = 300, bbox_inches = "tight")
plt.show()
...
plt.legend()
plt.savefig("D:\dataset(spotify_139k_)\images/energy_vs_danceabilty.png", dpi = 300, bbox_inches = "tight")
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("D:\dataset(spotify_139k_)\images/top10_songs.png", dpi = 300, bbox_inches = "tight")
plt.show()
